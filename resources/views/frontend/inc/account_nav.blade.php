                    ...
                    <div class="u-sidebar__content u-header-sidebar__content">
                            ...
                            <form method="POST" action="{{route('login')}}">
                                ...
                                <header class="border-bottom px-4 px-md-6 py-4">
                                    <h2 class="font-size-3 mb-0 d-flex align-items-center"><i class="flaticon-user mr-3 font-size-5"></i>@lang('Login')</h2>
                                </header>
                                <!-- End Title -->
                                ...
                                <div class="p-4 p-md-6">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="js-form-message js-focus-state">
                                            <label id="signinEmailLabel" class="form-label @error('email') is-invalid @enderror" value="{{ old('email') }}" for="signinEmail">Username or email *</label>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="js-form-message js-focus-state">
                                            <label id="signinPasswordLabel" class="form-label" for="signinPassword">@lang('Password') *</label>
...
<!-- End Account Sidebar Navigation - Desktop -->    <!-- End Account Sidebar Navigation - Desktop -->
