...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('public/frontend/vendor/font-awesome/css/fontawesome-all.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('public/frontend/vendor/flaticon/font/flaticon.css')}}">
    <link rel="stylesheet" href="{{URL::asset('public/frontend/vendor/slick-carousel/slick/slick.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('public/frontend/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}">
    <link rel="stylesheet" href="{{URL::asset('public/frontend/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css')}}">

    <!-- JS Front -->
    <link rel="stylesheet" href=" {{URL::asset('public/frontend/vendor/animate.css/animate.css')}}">
    <link rel="stylesheet" href="{{URL::asset('public/frontend/vendor/hs-megamenu/src/hs.megamenu.css')}}">
            ...
            <div class="d-flex align-items-center position-relative flex-wrap">
                ...
                <div class="site-branding pr-7">
                    <a href="index.html" class="d-block mb-1">
                        <img class ="navbar-toggler-icon" src="{{ URL::asset('public/frontend/img/logo.png') }}" style="width: 100% ;"></img>
                    </a>
                </div>
                ...
                <div class="col-lg-4 mb-4 mb-md-0 ">
                    <div class="pb-md-6">
                        <a href="index.html" class="d-inline-block mb-5">
                            <img class ="navbar-toggler-icon" src=" {{ URL::asset('public/frontend/img/logo.png') }}
" style="width: 100% ;"></img>
...
<script src="{{ URL::asset('public/frontend/vendor/jquery/dist/jquery.min.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/jquery-migrate/dist/jquery-migrate.min.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/popper.js/dist/umd/popper.min.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/bootstrap/bootstrap.min.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/slick-carousel/slick/slick.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/multilevel-sliding-mobile-menu/dist/jquery.zeynep.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/hs-megamenu/src/hs.megamenu.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="{{ URL::asset('public/frontend/vendor/slick-carousel/slick/slick.min.js')}}"></script>

<!-- JS HS Components -->
<script src="{{ URL::asset('public/frontend/js/hs.core.js')}}"></script>
<script src="{{ URL::asset('public/frontend/js/components/hs.unfold.js')}}"></script>
<script src="{{ URL::asset('public/frontend/js/components/hs.malihu-scrollbar.js')}}"></script>
<script src="{{ URL::asset('public/frontend/js/components/hs.slick-carousel.js')}}"></script>
<script src="{{ URL::asset('public/frontend/js/components/hs.selectpicker.js')}}"></script>
<script src="{{ URL::asset('public/frontend/js/components/hs.show-animation.js')}}"></script>
