                ...
                <div class="bg-img-hero img-fluid rounded-md">
                    <div class="js-slick-carousel u-slick"
                        ...
                        <div class="px-4 px-md-6 px-lg-7 px-xl-10 d-flex min-height-530"
                             style="background-image: url(https://jomlehstore.com/public/uploads/images/30-01-2023/63d79538af7e6.jpeg);">
                                ...
                                <div class="media">
                                    <div class="media-body align-self-center mb-4 mb-lg-0">
                                        <p class="banner__pretitle text-uppercase text-gray-400 font-weight-bold mb-2"
                                           ...
                                           data-scs-animation-delay="200">mini title’</p>
                                        <h2 class="font-size-15 mb-3 pb-1"
                                            data-scs-animation-in="fadeInUp"
                                            data-scs-animation-delay="300">
                                            <span
                                                class="hero__title-line-1 font-weight-normal d-block">Main title </span>

                                        </h2>
                                        <a href="../shop/v3.html"
                                           class="banner_btn btn btn-wide bg-primary text-white rounded-xs"
    ...
    <section class="space-bottom-3">
        <div class="container">
            <header class="d-md-flex justify-content-between align-items-center mb-6">
                ...
                <a href="../shop/v3.html" class="d-flex h-primary">All Categories<span
            ...
            <div class="row row-cols-md-3 row-cols-xl-6 mb-10">
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="../shop/v3.html">
                            <div
                                class="d-flex align-items-center justify-content-center mb-0 width-100 height-100 text-primary-indigo bg-indigo-light rounded-circle mx-auto mb-4">
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="../shop/v3.html">
                            <div
                                class="d-flex align-items-center justify-content-center mb-0 width-100 height-100 text-tangerine bg-tangerine-light rounded-circle mx-auto mb-4">
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="../shop/v3.html">
                            <div
                                class="d-flex align-items-center justify-content-center mb-0 width-100 height-100 text-chili bg-chili-light rounded-circle mx-auto mb-4">
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="../shop/v3.html">
                            <div
                                class="d-flex align-items-center justify-content-center mb-0 width-100 height-100 text-carolina bg-carolina-light rounded-circle mx-auto mb-4">
                ...
                <div class="col mb-5 mb-xl-0">
                    <div class="text-center">
                        <a href="../shop/v3.html">
                            <div
                                class="d-flex align-items-center justify-content-center mb-0 width-100 height-100 text-punch bg-punch-light rounded-circle mx-auto mb-4">
    ...
    <section class="space-bottom-2 space-bottom-lg-3">
        <div>
            <header class="text-center mb-5 mb-lg-7">
                <h2 class="font-size-7 mb-0">Featured Products</h2>
            </header>
                        ...
                        <div
                            ...
                            <div class="woocommerce-loop-product__body product__body pt-3 text-center">
                                <div class="text-uppercase font-size-1 mb-1 text-truncate"><a
                                        href="../shop/single-product-v4.html">Categgory name</a></div>
                                <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark">
                                    <a href="../shop/single-product-v4.html">Title name </a></h2>
                                <div
                                    class="price d-flex align-items-center justify-content-center font-weight-medium font-size-3">
                                    <span class="woocommerce-Price-amount amount"><span
                                            class="woocommerce-Price-currencySymbol">$</span>29</span>
                                </div>
                                <div
                                    class="product__rating d-md-flex align-items-center justify-content-center font-size-2 d-none">
        ...
        <div class="container">
            <div class="bg-dark pl-xl-10 px-6 py-5 pt-lg-8 pb-lg-7s rounded-md">
                <div class="media d-block d-lg-flex">
                    <div class="media-body align-self-center mb-4 mb-lg-0">
                        <p class="banner__pretitle text-uppercase text-gray-400 font-weight-bold">got app</p>
                        <h2 class="banner__title font-size-10 font-weight-bold text-white mb-4">downaoad our app
                            here </h2>
                        <a href="../shop/v7.html" class="banner_btn btn btn-wide btn-primary text-white">google
                            play </a>
                        <a href="../shop/v7.html" class="banner_btn btn btn-wide btn-primary text-white">App store</a>


                    </div>
                    <img src="assets/img/phone.png" style="width:300px" class="img-fluid" alt="image-description">
                </div>
            </div>
        </div>
    </div>
