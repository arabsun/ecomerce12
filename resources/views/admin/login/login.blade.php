...
<div align="center" style="margin: auto;">
    ...
    <img src="{{url('/')}}/assets/admin/images/logo.png" style="height: 50px;">
    <br><br>
    <span style="color: #888;">@Arab Sun Tech</span>
            ...
            <div id="login">
                <form id="loginform" action="{{ route('admin.login.submit') }}" method="POST">
                    ...
                    <div style="position: relative;margin: 0;padding: 0;margin-bottom:-4px" class="dv">
                        <input type="text" placeholder="email" autocomplete="off" style="border-bottom: none;"
                               id="email" value="" tabindex="1" name="email" size="30" class="username ">
                    </div>
                    <div style="position: relative;margin: 0;padding: 0;margin-top:-4px" class="dv">
                        <input type="password" autocomplete="off" tabindex="2" placeholder="Password" name="password"
