                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                                <div class="card">
                                    ...
                                    @foreach ($details as $item)
                                        <li class="list-group-item d-flex justify-content-between"><b>Name :</b>
                                            <span>{{$item->name}}</span></li>
                                        <li class="list-group-item d-flex justify-content-between"><b>Quantity :</b>
                                            <span>{{$item->quantity}}</span></li>
                                        <li class="list-group-item d-flex justify-content-between"><b>Price :</b>
                                            <span>{{priceConv($item->price)}} {{curr()->code}}</span></li>
                                        @if ($item->attributes)
                                            <hr>
                                            <h6 class="mb-2">Services</h6>
                                            @foreach ($item->attributes as $attr)
                                                <li class="list-group-item justify-content-between">{{$attr}}</li>
                                            @endforeach
                                        @endif
                                    @endforeach
                                </div>
